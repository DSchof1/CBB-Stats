...
source("Data/year.R")
if(offseason == TRUE & preseason == FALSE){
  day0 <- as.character(as.Date(last_year_last_day_of_games))
  day1 <- as.character(as.Date(last_year_last_day_of_games)+1)
  day2 <- as.character(as.Date(last_year_last_day_of_games)+2)
  day3 <- as.character(as.Date(last_year_last_day_of_games)+3)
  day4 <- as.character(as.Date(last_year_last_day_of_games)+4)
} else if(offseason == FALSE & preseason == TRUE){
  day0 <- as.character(as.Date(first_day_of_games))
  day1 <- as.character(as.Date(first_day_of_games)+1)
  day2 <- as.character(as.Date(first_day_of_games)+2)
